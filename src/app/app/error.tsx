    ...
    <div className="mx-auto flex min-h-[60vh] w-full max-w-md flex-col items-center justify-center px-4 text-center">
      <div className="rounded-3xl border border-white/10 bg-zinc-900 p-8">
        ...
        <p className="mt-3 text-sm leading-6 text-zinc-400">
          No es tu plata, es Kipu. Tus datos están a salvo. Probá de nuevo; si sigue, vuelve al inicio y cuéntame qué hacías.
        </p>
        <div className="mt-6 flex flex-col gap-2">
          ...
          <Link
            href="/app"
            className="rounded-2xl border border-white/10 px-5 py-3 text-sm font-semibold text-zinc-300 transition hover:border-white/20"
          >
            Volver al inicio
          </Link>
        </div>
