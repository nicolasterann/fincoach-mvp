...
${fixed}
ACTIVOS (patrimonio, NO gastable — cuentan en net worth, nunca en el Saldo):
${assets}
...
export async function refreshAgentStateBeforeModel(
  ...
  return `ESTADO POST-ESCRITURA ACTUALIZADO (reemplaza cualquier cifra anterior de Saldo):\n${ctx.briefing.digest}`;
}
